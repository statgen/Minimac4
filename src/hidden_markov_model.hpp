...
private:
  ...
  void transpose(const std::vector<float>& from, std::vector<float>& to, const std::vector<float>& from_norecom, std::vector<float>& to_norecom, const std::vector<std::size_t>& uniq_cardinalities, double recom, std::size_t n_templates);
  void impute_old(const std::vector<float>& probs, const std::vector<std::int8_t>& template_haps, std::int8_t observed, float err, float af, best_templates_results& output, std::size_t row, std::size_t column);
  void impute(const std::vector<float>& probs,
  ...
  void impute2(const std::vector<float>& probs,
    const std::vector<float>& left_probs,
    const std::vector<float>& right_probs,
    const std::vector<float>& left_probs_norecom,
    const std::vector<float>& right_probs_norecom,
